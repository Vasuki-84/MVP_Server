...
route('GET', '/users/patients', [UserController::class, 'listRegisterPatients']);
route('GET', '/users/doctors', [UserController::class, 'listDoctors']);
route('GET', '/patient/patients', [UserController::class, 'listPatients']);
...
routeWithId('PUT', '/messages',     [MessageController::class, 'update']);
routeWithId('DELETE', '/messages',  [MessageController::class, 'destroy']);
